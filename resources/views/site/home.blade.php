                ...
                <div class="row clearfix">
                    ...
                    <div class="content-column col-lg-7 col-md-12 col-sm-12">
                        <div class="inner-column">
                            ...
                            <div class="text">Where you are at the heart of our mission. We hope you will consider us as
                                ...
                                multi-specialty medical group,</div>
                    ...
                    <div class="image-column col-lg-5 col-md-12 col-sm-12">
                        <div class="inner-column wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <div class="image">
                                <img src="Site/images/resource/image-3.jpg" alt="" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="tabs-content">
                            ...
                            <div class="tab" id="tab-urology">
                                <div class="content">
                                    ...
                                    <a href="doctors-detail.html" class="theme-btn btn-style-two"><span class="txt">View
                                            More</span></a>
                                </div>
                            </div>
                ...
                <div class="row clearfix">
                    ...
                    <div class="image-column col-lg-6 col-md-12 col-sm-12">
                        <div class="inner-column wow slideInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <div class="image">
                                <img src="Site/images/resource/doctor-2.png" alt="" />
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                            <button class="theme-btn btn-style-two" type="submit" name="submit-form"><span
                                                    class="txt">Book Appointment</span></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
        ...
        <div class="auto-container">
            ...
            <div class="testimonial-carousel owl-carousel owl-theme">
                ...
                <div class="testimonial-block-two">
                    <div class="inner-box">
                        <div class="image">
                            <img src="Site/images/resource/author-4.jpg" alt="" />
                        </div>
                        <div class="text">Medical Centre is a great place to get all of your medical needs. I came in for a
                            check up and did not wait more than 5 minutes before I was seen. I can only imagine the type of
                            service you get for more serious issues. Thanks!</div>
                        <div class="lower-box">
                            <div class="clearfix">
                ...
                <div class="testimonial-block-two">
                    <div class="inner-box">
                        <div class="image">
                            <img src="Site/images/resource/author-5.jpg" alt="" />
                        </div>
                        <div class="text">Medical Centre is a great place to get all of your medical needs. I came in for a
                            check up and did not wait more than 5 minutes before I was seen. I can only imagine the type of
                            service you get for more serious issues. Thanks!</div>
                ...
                <div class="row clearfix">
                    ...
                    <div class="doctor-block col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                            ...
                            <div class="text">The following is for guidance only to help you plan your appointment with a
                                preferred doctor or nurse. It does not guarantee availability as the doctors or nurses may
                                sometimes be attending to other duties.</div>
                ...
                @foreach ($articals as $artical)
                    ...
                    <div class="news-block-two col-lg-6 col-md-12 col-sm-12">
                        <div class="inner-box">
                            <div class="image">
                                <a href="blog-detail">
                                    <img src="{{asset('images_admin/'.$artical->image)}}" style="width: 502px; height: 302px; " alt="" /></a>
                            </div>
                            <div class="lower-content">
                                <div class="content">
                                    <ul class="post-info">
...
{{--                                        <li>June 21, 2018 at 8:12pm</li>--}}
                                    ...
                                    <div class="text">{{ $artical->description }}</div>
                                    <a href="blog-detail.html" class="theme-btn btn-style-five"><span class="txt"> {{trans('Articals.read_more')}}</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
...
{{--                                            <li>June 21, 2018 at 8:12pm</li>--}}
                                        ...
                                        <div class="text">{{ $artical->description }}</div><a href="blog-detail.html" class="theme-btn btn-style-five"><span class="txt">
                                                {{trans('Articals.read_more')}}</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
{{--                    <div class="inner-box">--}}
{{--                        <div class="image">--}}
{{--                            <a href="blog-detail.html"><img src="Site/images/resource/news-5.jpg" alt="" /></a>--}}
{{--                        </div>--}}
{{--                        <div class="lower-content">--}}
{{--                            <div class="content">--}}
{{--                                <ul class="post-info">--}}
...
{{--                                <div class="text">There are a lot of women that are unaware of the numerous risks associated--}}
{{--                                    with their health and eventually ignore the ...</div>--}}
        ...
        <div class="outer-container">
            ...
            <div class="sponsors-outer">
                ...
                <ul class="sponsors-carousel owl-carousel owl-theme">
                    <li class="slide-item">
                        <figure class="image-box"><a href="#"><img src="Site/images/clients/1.png" alt=""></a></figure>
                    </li>
                    <li class="slide-item">
                        <figure class="image-box"><a href="#"><img src="Site/images/clients/2.png" alt=""></a></figure>
                    </li>
                    <li class="slide-item">
                        <figure class="image-box"><a href="#"><img src="Site/images/clients/3.png" alt=""></a></figure>
                    </li>
                    <li class="slide-item">
                        <figure class="image-box"><a href="#"><img src="Site/images/clients/4.png" alt=""></a></figure>
                    </li>
                    <li class="slide-item">
                        <figure class="image-box"><a href="#"><img src="Site/images/clients/5.png" alt=""></a></figure>
                    </li>
                    <li class="slide-item">
                        <figure class="image-box"><a href="#"><img src="Site/images/clients/1.png" alt=""></a></figure>
                    </li>
